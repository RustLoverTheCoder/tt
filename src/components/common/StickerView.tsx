import React, { memo, useMemo, useState,FC } from 'react';
    ...
    <>
      ...
      {isLottie ? (
        <AnimatedSticker
          ...
          isLowPriority={isSmall && !selectIsAlwaysHighPriorityEmoji(stickerSetInfo)}
        ...
        <OptimizedVideo
          ...
          className={clsx(styles.media, fullMediaClassName, fullMediaClassNames)}
          src={fullMediaData}
          playsInline
          muted
          loop={!loopLimit}
