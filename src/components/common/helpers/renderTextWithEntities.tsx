...
function renderMessagePart(
  ...
  const emojiFilter =
    emojiSize && emojiSize > HQ_EMOJI_THRESHOLD ? "hq_emoji" : "emoji";
...
function processEntity(
  ...
  switch (entity.type) {
    case ApiMessageEntityTypes.Bold:
      return (
        <strong data-entity-type={entity.type}>
    ...
    case ApiMessageEntityTypes.Code:
      return (
        <code
          className={clsx("text-entity-code", !isProtected && "clickable")}
    ...
    case ApiMessageEntityTypes.Italic:
      return (
        <em data-entity-type={entity.type}>{renderNestedMessagePart()}</em>
      );
    ...
    case ApiMessageEntityTypes.Strike:
      return (
        <del data-entity-type={entity.type}>{renderNestedMessagePart()}</del>
      );
    case ApiMessageEntityTypes.TextUrl:
    case ApiMessageEntityTypes.Url:
      return (
        <SafeLink url={getLinkUrl(entityText, entity)} text={entityText}>
          {renderNestedMessagePart()}
        </SafeLink>
      );
    case ApiMessageEntityTypes.Underline:
      return (
        <ins data-entity-type={entity.type}>{renderNestedMessagePart()}</ins>
      );
    case ApiMessageEntityTypes.Spoiler:
      return (
        <Spoiler messageId={messageId}>{renderNestedMessagePart()}</Spoiler>
      );
...
function processEntityAsHtml(
  ...
  switch (entity.type) {
    ...
    case ApiMessageEntityTypes.Pre:
      return `\`\`\`${renderText(entity.language || "", [
        "escape_html",
      ])}<br/>${renderedContent}<br/>\`\`\`<br/>`;
    case ApiMessageEntityTypes.Strike:
