...
function treeToElements(tree: Element | Root): ReactNode {
  ...
  if (tree.type === 'root') {
    return React.createElement('code', { className: 'hljs custom-scroll-x' }, children) as unknown as ReactNode;
  }
  ...
  return React.createElement(name, { className }, children) as unknown as ReactNode;
}
